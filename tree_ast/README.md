...
- Do rozwiązania zadania można użyć generatora parserów `SLY` lub `PLY`.
...
- Do stworzenia translatora, można użyć poprzednio stworzonych plików skanera oraz parsera. Nowe pliki, które zostaną stworzone, to AST.py, TreePrinter.py oraz main.py.
